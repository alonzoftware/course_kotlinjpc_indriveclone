...
import net.alonzochoque.indriveclone.presentation.screens.auth.login.components.LoginContent
...
fun LoginScreen(navHostController: NavHostController) {
    ...
    Scaffold(
        ...
        LoginContent(navHostController = navHostController, paddingValues = innerPadding)
    }
}